...
- Add support for post/pre configure script arguments, both globally and per configuration [#151](https://github.com/microsoft/vscode-makefile-tools/issues/151)
