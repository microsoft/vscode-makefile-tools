...
<<<<<<< copilot/update-makefile-config-experience
- Remove dry-run timeout popup during configuration. [#572](https://github.com/microsoft/vscode-makefile-tools/issues/572)
=======
