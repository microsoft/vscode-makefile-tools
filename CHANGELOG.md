...
- Ensure that tooltips for the project outline are reasonable. If they are path, display the path, if not, provide a description. [#600](https://github.com/microsoft/vscode-makefile-tools/issues/600)
