...
- Any arguments that you'd like to pass to the preConfigureScript should be set vie **makefile.preConfigureArgs**
...
- Any arguments that you'd like to pass to the postConfigureScript should be set vie **makefile.postConfigureArgs**
